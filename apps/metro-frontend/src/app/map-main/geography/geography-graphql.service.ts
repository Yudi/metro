...
import {
  ...
  convertToBusShape,
  convertToBusStop,
} from './geography-graphql.mapper';
import { ROUTE_FIELDS, STOP_FIELDS } from './geography-graphql.queries';
