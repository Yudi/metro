...
describe('notificationDeviceLabel', () => {
  it.each([
    ...
    ['Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36 Edg/130.0.0.0', 'Microsoft Edge · Windows'],
  ...
  it('distinguishes desktop-mode iPads from Macs using touch support', () => {
    const userAgent = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.0 Safari/605.1.15';
