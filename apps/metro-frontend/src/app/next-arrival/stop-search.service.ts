...
import {
  STOP_SEARCH_QUERY,
  NextArrivalComponentSearchResult,
  type NextArrivalSearchItem,
} from './next-arrival-search.types';

// Re-export types for backward compatibility
export type { SearchResult, SearchResultType };
export type { NextArrivalComponentSearchResult } from './next-arrival-search.types';
